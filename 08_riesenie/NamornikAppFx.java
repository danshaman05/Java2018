...
public class NamornikAppFx extends Application {
	...
	public void start(Stage primaryStage) {
		Pane pane = new Pane(new NamornikCanvasx()); // do panelu vlozime Canvas
...
class NamornikCanvasx extends Canvas {
	/** sirka appletu */
	int sizeX = 600;
	/** vyska appletu */
	int sizeY = 600;
...
class NamornikFx extends Thread {
	...
	public NamornikFx(NamornikCanvasx where) {
