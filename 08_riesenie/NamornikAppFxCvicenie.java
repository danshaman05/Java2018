...
class NamornikCanvas extends Canvas {
	...
	private NamornikFxx namornik;

	public NamornikCanvas() {
		this.setWidth(sizeX);
		this.setHeight(sizeY);
		// vytvor namornika
		namornik = new NamornikFxx(this);
 ...
 */
class NamornikFxx extends Thread {
	double x;
	/** poloha namornika - x */
	double y;
	/** poloha namornika - y */
	...
	public NamornikFxx(NamornikCanvas where) {
